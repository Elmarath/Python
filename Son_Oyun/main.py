...
class Game:
    ...
    def load_data(self):
        ...
        self.player_img = pg.transform.scale(self.player_img, (70, 70))
        self.bullet_images = {}
        self.bullet_images['lg'] = pg.transform.rotate(pg.image.load(
            path.join(img_folder, BULLET_IMG)).convert_alpha(), 270)
        ...
        self.knight_img = pg.transform.rotate(self.mob_img, 270)
    ...
    def new(self):
        ...
        for tile_object in self.map.tmxdata.objects:
            ...
            if tile_object.name == 'knight':
                Knight(self, obj_center.x, obj_center.y)
            if tile_object.name == 'wizard':
                Wizard(self, obj_center.x, obj_center.y)
            if tile_object.name == 'archer':
                Archer(self, obj_center.x, obj_center.y)
